...
raw_rel_tac_low_seed_low_rcp = CSV.read("./Outputs/raw_rel_tac_seed_1e6_rcp45.csv", DataFrame; header=false, types=Float64)
raw_rel_tac_low_seed_high_rcp = CSV.read("./Outputs/raw_rel_tac_seed_1e6_rcp70.csv", DataFrame; header=false, types=Float64)
raw_rel_tac_high_seed_low_rcp = CSV.read("./Outputs/raw_rel_tac_seed_1e8_rcp45.csv", DataFrame; header=false, types=Float64)

raw_fd_low_seed_low_rcp = CSV.read("./Outputs/raw_fd_seed_1e6_rcp45.csv", DataFrame; header=false, types=Float64)
raw_fd_low_seed_high_rcp = CSV.read("./Outputs/raw_fd_seed_1e6_rcp70.csv", DataFrame; header=false, types=Float64)
raw_fd_high_seed_low_rcp = CSV.read("./Outputs/raw_fd_seed_1e8_rcp45.csv", DataFrame; header=false, types=Float64)

raw_rel_tac = (raw_rel_tac_low_seed_low_rcp, raw_rel_tac_low_seed_high_rcp, raw_rel_tac_high_seed_low_rcp)
raw_fd = (raw_fd_low_seed_low_rcp, raw_fd_low_seed_high_rcp, raw_fd_high_seed_low_rcp)

titles = ("seed=1e6, RCP=45", "seed=1e6, RCP=70", "seed=1e8, RCP=45")
...
# Log to be placed inside two_sided_cvar
